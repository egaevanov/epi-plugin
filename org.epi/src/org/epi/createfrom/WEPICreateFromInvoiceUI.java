...
public class WEPICreateFromInvoiceUI extends EPICreateFromInvoice implements EventListener<Event>, ValueChangeListener
{
	private WCreateFromWindow window;
	
	public WEPICreateFromInvoiceUI(GridTab tab) 
	{
		super(tab);
	...
	protected void zkInit() throws Exception
	{
        ...
        if (ClientInfo.isMobile()) {    		
			...
			ClientInfo.onClientInfo(window, new Runnable() {
...
//		System.out.println("Organization -------------->"+AD_Org_ID);
		...
		ArrayList<KeyNamePair> list = LoadOrderData(C_BPartner_ID, forInvoice, false, isCreditMemo,AD_Org_ID);
		...
		initBPDetails(C_BPartner_ID, AD_Org_ID);
	}   //  initBPartnerOIS
	
	public void initBPDetails(int C_BPartner_ID, int InvoiceOrg) 
	{
		initBPShipmentDetails(C_BPartner_ID,InvoiceOrg);
		initBPRMADetails(C_BPartner_ID, InvoiceOrg);
	}
	 ...
	 * @param C_BPartner_ID
	 */
	private void initBPShipmentDetails(int C_BPartner_ID,int  InvoiceOrg)
	{
		if (log.isLoggable(Level.CONFIG)) log.config("C_BPartner_ID" + C_BPartner_ID);
		...
		ArrayList<KeyNamePair> list = LoadShipmentData(C_BPartner_ID,InvoiceOrg);
		for(KeyNamePair knp : list)
	 ...
	 * @param C_BPartner_ID BPartner
	 */
	private void initBPRMADetails(int C_BPartner_ID, int InvoiceOrg)
	{
	    ...
	    ArrayList<KeyNamePair> list = LoadRMAData(C_BPartner_ID, InvoiceOrg);
		for(KeyNamePair knp : list)
