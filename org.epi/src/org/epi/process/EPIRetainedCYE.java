...
public class EPIRetainedCYE extends SvrProcess {
...
//		SQLCheckCYE.append(" AND C_AcctSchema_ID = ?");
		...
		SQLCheckCYE.append(" AND re.Value = 'CYE' ");
		...
		PreparedStatement pstmt = null;
     	ResultSet rs = null;
			...
			if(IsExist) {
				...
				journal.setDescription("GL Current Year Earnings");
				...
				if(count > 0) {
					...
					if(journal.save()) {
						...
						RELog.setC_Period_ID(p_C_Period_ID);
						RELog.saveEx();
