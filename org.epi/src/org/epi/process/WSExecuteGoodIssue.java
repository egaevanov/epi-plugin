...
public class WSExecuteGoodIssue {
	...
	public static Integer CreateGoodIssue(int AD_Client_ID, int AD_Org_ID, API_Model_GoodIssue dataHeader,API_Model_GoodIssueLines[] dataDetails, Properties ctx , String trxName, int A_Asset_ID,HashMap<String, Integer> MapProduct) {
				...
				for (API_Model_GoodIssueLines detail : dataDetails) {
					...
					for(int i = 0 ; i < 2 ; i++) {
						...
						if(i == 0) {
							...
							journalLine.setAmtSourceCr(DR);
							journalLine.setAmtAcct(Env.ZERO, DR);
						}
