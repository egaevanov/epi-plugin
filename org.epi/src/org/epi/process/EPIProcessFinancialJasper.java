 ...
 */
public class EPIProcessFinancialJasper extends SvrProcess
{
	/**	Period Parameter				*/
...
//	private MReport				m_reportJasper = null;
	
	private int 				p_MonthColumn = 0;
	...
	protected void prepare()
	{
		...
		for (int i = 0; i < para.length; i++)
		{
			...
			else if (name.equals("MonthColumn"))
				p_MonthColumn = para[i].getParameterAsInt();
			else
