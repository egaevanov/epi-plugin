...
public class EPIDocInventory extends Doc
{
	 ...
	 * 	@param trxName trx
	 */
	public EPIDocInventory (MAcctSchema as, ResultSet rs, String trxName)
	{
			...
			else 
			{
				if (!isReversal(line))
				{
					...
					if (costs == null || costs.signum() == 0)
					{
						...
						if(!prod.get_ValueAsBoolean("IsUnValuatedMaterial")) {
