...
public class EPIProductCost
{
	 ...
	 *	@param trxName trx
	 */
	public EPIProductCost (Properties ctx, int M_Product_ID, int M_AttributeSetInstance_ID, 
		String trxName)
	{
	...
	/**	Logger					*/
	private static CLogger 	log = CLogger.getCLogger (EPIProductCost.class);
	...
	//add by tegar
	/**ISM DownPayment Manual Jurnal*/
	public static final int ACCTTYPE_P_ISM_DP = 25;
	...
	public MAccount getAccount(int AcctType, MAcctSchema as)
	{
		...
		String sql = "SELECT P_Revenue_Acct, P_Expense_Acct, P_Asset_Acct, P_Cogs_Acct, "	//	1..4
			...
			+ "P_LandedCostClearing_Acct, P_DP_Acct "									//  24,25
			+ "FROM M_Product_Acct "
